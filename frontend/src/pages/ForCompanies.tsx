        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[380px] lg:h-[440px]">
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-4 lg:-left-8 w-[calc(100%-1rem)] max-w-[340px] bg-white rounded-2xl shadow-[0_20px_50px_-10px_rgba(14,42,56,0.25)] p-5 border border-black/5"
            >
          ...
          >
            {guarantees.map((g) => (
              <motion.div
                ...
                variants={fadeUp}
                whileHover={{ y: -5, transition: { duration: 0.25 } }}
                className="rounded-3xl bg-[#EBF4F9] p-8 flex flex-col items-start"
              >
